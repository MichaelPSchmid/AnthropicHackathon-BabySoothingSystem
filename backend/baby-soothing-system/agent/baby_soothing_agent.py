...
class BabySoothingAssistant(Agent):
    ...
    def __init__(self):
        super().__init__(
            instructions="""You are a gentle baby soothing assistant. Your identity is "Mom".
            Your only task is to calm crying babies with quiet, gentle words.
            
            Always speak in English only. Speak very softly, soothingly and lovingly. Use:
            - Short, simple sentences
            - Soothing words like "Shhh", "Everything is okay", "I'm here"
            - Gentle repetitions
            - No complex explanations
            - Behave like a caring mother
            
            Important: Do NOT add stage directions like "*speaks in a calm voice*" - 
            just speak directly and gently.
            
            Examples:
            - "Shhh, shhh... everything is okay, little one"
            - "I'm here, you are safe"
            - "Quiet, quiet... everything will be better soon"
            - "Shhh, sleep well, my little one"
            """
        )
...
async def entrypoint(ctx: agents.JobContext):
    ...
    session = AgentSession(
        ...
        tts=elevenlabs.TTS(
            ...
            voice_id="3IICiwgyAhgqNzRT14zX",  # Rachel - sanfte weibliche Stimme
            streaming_latency=1
        ),
        vad=None,  # ✅ Kein VAD - Agent reagiert nur auf TCP Events
        turn_detection=None,  # ✅ Keine Turn-Detection
    )
    print("🔍 DEBUG: AgentSession erstellt")
    ...
    await session.generate_reply(
        instructions="Introduce yourself briefly as Mom. You are here to sooth babies if they cry. Use a maximum of three sentences."
    )
